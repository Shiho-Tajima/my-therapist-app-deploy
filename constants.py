...
FINE_TUNING_TEMPERATURE = 0.5
JSONL_FILE_NAME = r"D:\therapist_app\data\output.jsonl"
...
SUPPORTED_EXTENSIONS = {
    ...
    ".txt": lambda path: TextLoader(path, encoding="utf-8")  # ★問題５ 追記
}
